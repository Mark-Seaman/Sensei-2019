...
def update_projects():
    ...
    create_project_record('bacs200', '08', 'bacs200/learn.html',           fake_project_requirements())
    create_project_record('bacs200', '09', 'bacs200/teach.html',           fake_project_requirements())
    create_project_record('bacs200', '10', 'bacs200/index.html',           fake_project_requirements())
    create_project_record('bacs200', '11', 'bacs200/marketing.html',       fake_project_requirements())
    ...
    create_project_record('bacs350', '11', 'bacs350/slides.php',           fake_project_requirements())
